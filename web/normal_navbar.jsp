<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="index.jsp"><span class="fa fa-bell-o"></span>Tech Blog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
       ...
       <li class="nav-item ">
        <a class="nav-link" href="login_page.jsp"><span class="fa fa-address-book fa fa-user-circle"></span>Login</a>
      </li>
